	...
	<fieldset id="ldapSettings-2">
		<div id="ldapAdvancedAccordion">
			...
			<div>
				...
				<p><label for="ldap_user_display_name_2"><?php p($l->t('Second Display Name Field'));?></label><input type="text" id="ldap_user_display_name_2" name="ldap_user_display_name_2" data-default="<?php p($_['ldap_user_display_name_2_default']); ?>" placeholder="<?php p($l->t('Optional; a second feature for the display name.'));?>" title="<?php p($l->t('Optional. An LDAP attribute to be added to the display name in brackets. Results in e.g. »John Doe (john.doe@example.org)«.'));?>" /></p>
